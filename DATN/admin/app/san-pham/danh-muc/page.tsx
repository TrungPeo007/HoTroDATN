...
export default function DanhMucManagementPage() {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const res = await fetch("http://localhost:5000/api/admin/danh-muc-tin", {
        method: "GET",
        credentials: "include",
      });
  ...
  // Sort data by parent-child relationship
  const getSortedData = () => {
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    ...
                    {data
                      .filter((dm) => dm.id !== editingId) // Không cho chọn chính nó
                      .map((dm) => (
